...
public class MenuPrincipalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnedtSesion.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent modifyUserIntent = new Intent(MenuPrincipalActivity.this, UserProfileActivity.class);
        ...
        btnAgregar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent addContactIntent = new Intent(MenuPrincipalActivity.this, AgregarContactoActivity.class);
